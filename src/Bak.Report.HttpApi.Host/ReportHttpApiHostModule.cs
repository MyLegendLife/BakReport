...
using Bak.Report.EntityFrameworkCore;
using Bak.Report.HttpApi.Host.Filters;
using Bak.Report.HttpApi.Host.Middlewares;
using Bak.Report.Swagger;
    ...
    public class ReportHttpApiHostModule : AbpModule
    {
        ...
        private void ConfigureException()
        {
            Configure<MvcOptions>(options => {
                ...
                // 添加自定义异常处理
                options.Filters.Add(typeof(ReportExceptionFilter));
            });
        }
